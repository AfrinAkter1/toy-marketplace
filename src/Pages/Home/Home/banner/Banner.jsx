...
const Banner = () => {
    return (
      <div >
        <div  className="hero max-w-full min-h-screen " style={{ backgroundImage: `url("https://img.freepik.com/free-vector/blue-sports-car-isolated-white-vector_53876-67418.jpg?size=626&ext=jpg&ga=GA1.1.977297310.1680196639&semt=sph")` }}>
